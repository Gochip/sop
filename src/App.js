...
echo -e "\${SIN_COLOR}Le quitamos el color, será el color por default."`}
                ...
                <p>
                    Se pueden consultas más colores en <a href="https://gist.github.com/jonsuh/3c89c004888dfc7352be">https://gist.github.com/jonsuh/3c89c004888dfc7352be</a>
                </p>
            </div>
        );
    }
    ...
    render() {
        return (
            <div className="contenido-cuerpo">
                ...
                <p>Existen 3 alternativas para realizar operaciones aritméticas:</p>
                <ol>
                    <li>Usar la palabra reservada let.</li>
                    <li>Usar el comando expr.</li>
                    <li>Usar la construcción $(( 2 + 4 )).</li>
                </ol>

                <h6>Usar la palabra reservada let</h6>
                <p>
